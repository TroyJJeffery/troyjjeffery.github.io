...
public class Simulator
{
    ...
    {
        int liveFox, deadFox, liveRabbit, deadRabbit;
    ...
    public boolean verify()
    {
        ...
        boolean fail =
        v.compare(field.getField(), verifyAnimals());
    ...
    public void test()
    {
        ...
        for(int i = 0; i<simulations;i++){
            simulate(turns);
            rabbitNum = rabbitNum + rabbits.size();
            foxNum = foxNum +foxes.size();
            reset();
        }
    
        rabbitNum = rabbitNum/simulations;
        foxNum = foxNum/simulations;
    
        System.out.println("Ran: " + simulations + " simulations" + 
                           " for " + turns + " turns " + 
                           "  Rabbit avg: " + rabbitNum + 
                           "  Fox avg: " + foxNum);
    }
